...
public class ViewActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(viewData.getCode() != null) {
            String imageUrl = "http://www.weather-picture.or.kr/storage/images/weather/photo//thumb/w600/" + imageCode + "_w600.jpg";
            DownloadImageTask newTask = new DownloadImageTask((ImageView)findViewById(R.id.picView));
            newTask.execute(imageUrl);
